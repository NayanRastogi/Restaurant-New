...
namespace BusinessLogicLayer
{
    public class ClsDiningTableBLL
    {
        ...
        public DataTable SelectDiningTable()
        {
            ...
            objSqlParam[4] = new SqlParameter("@Status", Status);
            ...
            DataSet dsResult = SqlHelper.ExecuteDataset(DBConnection.ConStr, CommandType.StoredProcedure, "USP_DiningTable", objSqlParam);
